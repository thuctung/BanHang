...
INSERT INTO `Account` VALUES (1,'admin','admin',0),(2,'thuctung','thuctung',NULL);
...
CREATE TABLE `DonHang` (
  ...
  `NgayTao` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `KhachHang` VALUES (1,'Nguyễn Thúc Tùng','0385323666','Quy Nhơn','thuc@gmail.com'),(2,'Trần Văn Ngu','0935246578','Đà Nẵng','thuctung@gmail.com');
/*!40000 ALTER TABLE `KhachHang` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `KhuyenMaiHot`
--

DROP TABLE IF EXISTS `KhuyenMaiHot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `KhuyenMaiHot` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `KhuyenMaiHot`
--

LOCK TABLES `KhuyenMaiHot` WRITE;
/*!40000 ALTER TABLE `KhuyenMaiHot` DISABLE KEYS */;
INSERT INTO `KhuyenMaiHot` VALUES (1,1),(2,29),(3,43),(4,21),(5,33),(6,12),(7,45),(8,46),(9,47),(10,48),(11,49);
/*!40000 ALTER TABLE `KhuyenMaiHot` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `SanPham` VALUES (1,'Huawei P30 Pro',20690000,'huaweip30pro.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác)',1,2),(2,'Huawei Mate 20',15900000,'huaweimax20.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). (click xem chi tiết)\r\n',1,2),(3,'Huawei Nova 3i',4999000,'huaweinova3i.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). (click xem chi tiết)\r\n',1,2),(4,'Huawei Nova 3i Trắng',4990000,'huaweinova3itrang.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). (click xem chi tiết)\r\n',1,2),(5,'Huawei P30',15290000,'huaweip30.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). (click xem chi tiết)\r\n',1,2),(6,'Huawei P30 Lite',6290000,'huaweip30lite.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). (click xem chi tiết)\r\n',1,2),(7,'Huawei Y6 Prime',2390000,'huaweiy6prime.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). (click xem chi tiết)\r\n',1,2),(8,'Huawei Y7 Pro',4690000,'huaweiy7pro.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). (click xem chi tiết)\r\n',1,2),(9,'Huawei Y9',4490000,'huaweiy9.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). (click xem chi tiết)\r\n',1,2),(10,'Huawei Y9 Blue',5390000,'huaweiy9blue.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). (click xem chi tiết)\r\n',1,2),(11,'Iphone 6+',9490000,'iphone6splus.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(12,'Iphone 7+ 32G',11490000,'iphone7plus32g.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(13,'Iphone 8+ 64G',19450000,'iphone8plus64g.jpg	','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(14,'Iphone 7 32G',12590000,'iphone732g.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(15,'Iphone X 32G',22590000,'iphonex32g.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(16,'Iphone X 64G',23490000,'iphonex64g.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(17,'Iphone X 256G',24390000,'iphonex256g.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(18,'Iphone XR 128G',19990000,'iphonexr128g.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(19,'Iphone XR 256G',21990000,'iphonexr256g.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(20,'Iphone XS',26490000,'iphonexs.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(21,'Iphone XS Max	',34590000,'iphonexsmax.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(22,'Iphone XS Max 64G',37390000,'iphonexsmax64g.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,1),(23,'Oppo A1 K',3290000,'oppoa1k.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). ',1,3),(24,'Oppo A3 S',4999000,'oppoa3s.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). ',1,3),(25,'Oppo A5 S',3990000,'oppoa5s.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). ',1,3),(26,'Oppo A7',3590000,'oppoa7.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). ',1,3),(27,'Oppo A9 ',4790000,'oppoa9.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). ',1,3),(28,'Oppo A9 2020',5190000,'oppoa92020.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). ',1,3),(29,'Oppo F11',6290000,'oppof11.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). ',1,3),(30,'Oppo K3',5990000,'oppok3.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). ',1,3),(31,'Oppo R17 Pro',10990000,'oppor17pro.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác). ',1,3),(32,'Oppo Reno',11990000,'opporeno.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,3),(33,'Oppo Reno 10X',14990000,'opporeno10x.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,3),(34,'Samsung Galaxy Note 9',20490000,'samsunggalaxynote9.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(35,'Samsung Galaxy A9',12490000,'samsunggalaxya9.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(36,'Samsung Glaxy A50',6290000,'samsunggalaxya50.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(37,'Samsung Galaxy A50S',7790000,'samsunggalaxya50s.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(38,'Samsung Galaxy A70',7590000,'samsunggalaxya70.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(39,'Samsung Galaxy A80',7890000,'samsunggalaxya80.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(40,'Samsung Galaxy A80 Star',8590000,'samsunggalaxya80star.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(41,'Samsung Galaxy Note 10',22990000,'samsunggalaxynote10.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(42,'Samsung Galaxy Note 10+',24900000,'samsunggalaxynote10plus.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(43,'Samsung Galaxy S10+ ',23990000,'samsunggalaxys10plus.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(44,'Samsung Galaxy Tab S6',6990000,'samsunggalaxytabs6.jpg','Tặng suất mua Đồng hồ thời trang, mắt kính giảm ngay 40% (HSD: 7 ngày từ ngày mua hàng, không áp dụng KM khác).',1,4),(45,'Ipad Air 10.5 inch 2019',12490000,'ipadair105inch2019.jpg','Mua kèm Office 365 Personal ưu đãi giảm 600.000đ\r\n',2,1),(46,'Ipad Mini 2019',14590000,'ipadmini2019.jpg','Mua kèm Office 365 Personal ưu đãi giảm 600.000đ',2,1),(47,'Ipad Pro 11 inch 2017',22590000,'ipadpro11inch2019.jpg','Mua kèm Office 365 Personal ưu đãi giảm 600.000đ',2,1),(48,'Ipad Pro 10.5 inch 2017',13990000,'ipadpro105inch2017.jpg','Mua kèm Office 365 Personal ưu đãi giảm 600.000đ',2,1),(49,'Ipad Wifi 32G 2018',8990000,'ipadwifi32g2018.jpg','Mua kèm Office 365 Personal ưu đãi giảm 600.000đ',2,1),(50,'Ipad Wifi 128G 2018',9990000,'ipadwifi128g2018.jpg','Mua kèm Office 365 Personal ưu đãi giảm 600.000đ',2,1),(51,'Ipad Wifi Cellular 32G',11990000,'ipadwificellular32g2018.jpg','Mua kèm Office 365 Personal ưu đãi giảm 600.000đ',2,1),(52,'SamSung Galaxy Tab S6',18490000,'samsunggalaxytab.jpg','Mua kèm Office 365 Personal ưu đãi giảm 600.000đ',2,4);
/*!40000 ALTER TABLE `SanPham` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `SanPhamHot`
--
...
--
-- Dumping data for table `SanPhamHot`
--

LOCK TABLES `SanPhamHot` WRITE;
/*!40000 ALTER TABLE `SanPhamHot` DISABLE KEYS */;
INSERT INTO `SanPhamHot` VALUES (1,25),(2,26),(3,14),(4,24),(5,40),(6,9),(7,45),(8,49),(9,50);
...
-- Dump completed on 2019-11-08 16:39:02
